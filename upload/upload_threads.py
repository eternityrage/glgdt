...
GITHUB_REPO = "eternityrage/glgdt"
GITHUB_RAW = f"https://raw.githubusercontent.com/{GITHUB_REPO}/main/glgdt_short.mp4"


def host_video_on_github(video_path_obj):
    """
    Commit the video into the repo at glgdt_short.mp4 and return its
